    ...
    ####Visualization Path###############################################################
        with torch.no_grad():
            if epoch%valid_period==0:
                ...
                forward_visual_result = forward_visual_result.reshape(data_length,6)*kitti_dataset_t.motion_stds
                ...
                ground_truth = ground_truth.reshape(data_length,6)*kitti_dataset_t.motion_stds
